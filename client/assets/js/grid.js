...
function init(){
	...
	surveyContractInstance = surveyVotingContract.at('0xcdd8913719e7ea030fee37464c237bb067ae38c5');
	...
	surveyContractInstance.initialise({from: web3Chain1.eth.accounts[0]});	
	main();
